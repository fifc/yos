...
; Strings
system_status_header:	db 'NeOS v0.1.1', 0
readymsg:		db 'NeOS is ready', 0
cpumsg:			db '[cpu: ', 0
memmsg:			db ']  [mem: ', 0
networkmsg:		db ']  [net: ', 0
diskmsg:		db ']  [hdd: ', 0
...
nefs_directory:		equ 0x0000000000090000	; 4096 bytes	0x090000 -> 0x090FFF
...
nefs_TotalBlocks:	equ os_SystemVariables + 112

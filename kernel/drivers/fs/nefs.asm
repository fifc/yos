...
os_nefs_block_read:
	test rcx, rcx
	jz os_nefs_block_read_done	; Bail out if instructed to read nothing
...
os_nefs_block_write:
	test rcx, rcx
	jz os_nefs_block_write_done	; Bail out if instructed to write nothing
